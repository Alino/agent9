/* pyconfig.h for 9front/amd64 (APE), hand-adapted from the darwin
 * autoconf output of CPython 3.11.14. First cut: only critical-correctness
 * macros flipped; remaining HAVE_* are tuned iteratively as pcc surfaces
 * failures. See docs/wiki/concepts/python3-on-plan9.md.
 *
 * Two structural constraints this encodes:
 *   - no dynamic loading  -> static modules via Modules/Setup
 *   - no pthreads         -> Python/thread_plan9.h backend (TODO)
 */
...
/* #undef HAVE_PTHREAD_H */  /* plan9: unsupported */
