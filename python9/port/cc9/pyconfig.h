/* pyconfig.h for 9front/amd64 via cc9 (clang -> Plan 9 a.out, SysV LP64).
 * Derived from the kencc/APE port's pyconfig.h (port/plan9/), with the
 * APE/kencc workarounds dropped and the HAVE_* surface re-audited against
 * cc9/runtime (libcc9cxx.a symbols + runtime/include headers).
 *
 * Structural constraints (same as the kencc port):
 *   - no dynamic loading -> static module table (port/cc9/config.c)
 * New in this profile:
 *   - real pthreads (cc9 rfork(RFMEM) backend) -> threaded interpreter
 *   - poll(2) (cc9 poll layer) -> selectmodule uses poll
 */

#ifndef Py_PYCONFIG_H
#define Py_PYCONFIG_H

/* release build: strict C asserts off, as CPython release builds do */
#ifndef NDEBUG
#define NDEBUG 1
#endif

/* install-path macros normally passed by the Makefile as -D */
#ifndef PREFIX
...
/* sys.platform / sys.abiflags; sysconfig resolves _sysconfigdata__plan9_ */
#ifndef PLATFORM
...
/* Plan 9 is UTF-8 everywhere; use CPython's own UTF-8 codec for the
 * filesystem/locale encoding rather than the libc mbstowcs path. */
#define _Py_FORCE_UTF8_LOCALE 1

/* provided by port/cc9/cc9_compat.c (reads /dev/random) */
extern int getentropy(void *buf, unsigned long len);

/* cc9's pthread.h doesn't define _POSIX_THREADS; pycore_condvar.h keys its
 * POSIX-vs-NT choice on it. */
#define _POSIX_THREADS 1

/* clang's <stdatomic.h> uses ptrdiff_t/size_t without including <stddef.h>
 * itself (hosted chains provide it); pycore_atomic.h includes it directly. */
#include <stddef.h>
...
/* Define to 1 if you have the declaration of `RTLD_GLOBAL', and to 0 if you
   don't. */
/* #undef HAVE_DECL_RTLD_GLOBAL */  /* plan9: unsupported */

/* Define to 1 if you have the declaration of `RTLD_LAZY', and to 0 if you
   don't. */
/* #undef HAVE_DECL_RTLD_LAZY */  /* plan9: unsupported */

/* Define to 1 if you have the declaration of `RTLD_LOCAL', and to 0 if you
   don't. */
/* #undef HAVE_DECL_RTLD_LOCAL */  /* plan9: unsupported */
...
/* Define to 1 if you have the declaration of `RTLD_NOW', and to 0 if you
   don't. */
/* #undef HAVE_DECL_RTLD_NOW */  /* plan9: unsupported */
...
/* #undef HAVE_DLOPEN */  /* plan9: unsupported */
...
/* #undef HAVE_DYNAMIC_LOADING */  /* plan9: unsupported */
...
/* #undef HAVE_FORKPTY */  /* plan9: unsupported */
...
/* #undef HAVE_OPENPTY */  /* plan9: unsupported */
...
/* #undef HAVE_PTHREAD_KILL */  /* plan9: unsupported */

/* Define to 1 if you have the `pthread_sigmask' function. */
#define HAVE_PTHREAD_SIGMASK 1

/* Define if platform requires stubbed pthreads support */
/* #undef HAVE_PTHREAD_STUBS */  /* cc9: real pthreads over rfork(RFMEM) */
...
/* #undef HAVE_SYS_EVENT_H */  /* plan9: unsupported */
...
#define SIZEOF_LONG_DOUBLE 16  /* cc9: x87 80-bit long double (openlibm) */
...
#define SIZEOF_PTHREAD_KEY_T 4  /* cc9: int */

/* The size of `pthread_t', as computed by sizeof. */
#define SIZEOF_PTHREAD_T 8  /* cc9: unsigned long */
...
#define SIZEOF_WCHAR_T 4  /* clang x86_64: int */
