...
enum
{
	...
	/* WinXP Luna titlebar */
	Titlebar		= 22,		/* titlebar height (px) */
	Btnw			= 21,		/* close/min/max button width */
	Btnh			= 20,		/* button height */
	Btnpad		= 2,		/* gap between buttons */
	Titlepad		= 6,		/* left-side text indent */
};
...
struct Window
{
	...
	*/
	...
	uchar		keyup;
	uchar		winnameread;
	uchar		maximized;	/* WinXP: max toggle state */
	Rectangle	savedrect;	/* WinXP: pre-maximize geometry */
	char			*label;
	char			*dir;
};
