...
// Plan 9 (cc9) is in the same position as OpenBSD here: not glibc, and
// pthread_rwlock_t is only visible if <pthread.h> is actually included. cc9
// defines it (a plain mutex — readers serialize; see cc9/runtime/include/pthread.h).
#if defined(OPENSSL_OPENBSD) || defined(__plan9__)
#include <pthread.h>
#endif
