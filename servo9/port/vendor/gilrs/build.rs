...
fn main() {
    ...
    // Targets with no target_family (Plan 9 is one) leave CARGO_CFG_TARGET_FAMILY
    // unset, and unwrap() panicked. The match already has an "Unknown" arm for
    // exactly this case — it just never got the chance to run.
