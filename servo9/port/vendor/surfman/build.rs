...
fn main() {
    ...
    cfg_aliases! {
        ...
        // Plan 9 (9front): no X11, no Wayland — gl9 gives Mesa + EGL, so the
        // surfaceless backend is the whole story here. Deliberately NOT part of
        // free_unix.
        plan9_platform: { target_os = "plan9" },
    ...
    if target_os == "android"
        ...
        // Plan 9 uses EGL (gl9's Mesa exposes an EGL seam) but has no
        // target_family = "unix", so it misses the check above.
        || target_os == "plan9"
    {
