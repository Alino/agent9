#[cfg(not(any(target_os = "macos", windows, target_os = "plan9")))]
...
#[cfg(all(not(feature = "x11"), not(any(target_os = "macos", windows, target_os = "plan9"))))]
...
impl Window {
    ...
    pub fn get_platform_window(
        ...
        // with_name is the wayland/x11 app-id extension; nothing to name on
        // Plan 9 (gl9win2 owns the rio window).
        #[cfg(not(target_os = "plan9"))]
        let builder = builder.with_name(&identity.class.general, &identity.class.instance);
