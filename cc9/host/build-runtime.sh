...
for f in string stdexcept memory hash functional bind memory_resource system_error error_category valarray chrono expected exception locale ios iostream ostream; do
